ALTER TABLE projects ADD COLUMN IF NOT EXISTS owner_user_id TEXT NOT NULL DEFAULT 'anonymous';
ALTER TABLE projects ADD COLUMN IF NOT EXISTS owner_username TEXT NOT NULL DEFAULT 'anonymous';
